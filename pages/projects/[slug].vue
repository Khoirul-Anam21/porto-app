    <template>
    <!-- Blog Article -->
    <div class="w-full flex justify-between items-center px-4 sm:px-6 lg:px-8 mx-auto mt-24 h-max ">
    <div class="px-10 sm:px-20 lg:px-40">
        <!-- Content -->
        <div class="lg:col-span-2">
        <div class="py-8 lg:pe-4 w-full ">
            ...
            <div class="text-center">
                ...
                <figure class="relative w-full h-72 sm:h-96 lg:h-full">
                    <img class="w-full h-full absolute top-0 start-0 object-cover rounded-xl" src="https://images.unsplash.com/photo-1671726203394-491c8b574a0a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=988&q=80" alt="Image Description">
                </figure>
                </div>
            ...
            <blockquote class="text-center p-4 sm:px-7">
                <p class="text-xl font-medium text-gray-800 lg:text-2xl lg:leading-normal xl:text-2xl xl:leading-normal dark:text-gray-200">
